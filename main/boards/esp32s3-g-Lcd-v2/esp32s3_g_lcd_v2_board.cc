...
#define TAG "esp32s3_g_lcd_v2"

LV_FONT_DECLARE(font_puhui_20_4);
LV_FONT_DECLARE(font_awesome_20_4);

class Esp32S3GLCDV2Board : public WifiBoard {
private:
    Button boot_button_;
...
public:
    Esp32S3GLCDV2Board() : boot_button_(BOOT_BUTTON_GPIO) {
        ESP_LOGI(TAG, "Initializing esp32s3_g_lcd_v2 Board");
        InitializeI2c();
        I2cDetect();
...
DECLARE_BOARD(Esp32S3GLCDV2Board);
